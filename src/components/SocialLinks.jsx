...
export default function SocialLinks({ links = defaultLinks }) {
  const validLinks = links.filter((link) => validateUrl(link.url));

  return (
    <div className="social-links">
      {validLinks.map(({ platform, url, ariaLabel, icon: Icon }) => (
        <a
          key={platform}
          href={url}
          target="_blank"
